...
extern crate numpy;
use ndarray::{array, linspace, stack, Array1, Array2, ArrayView1, ArrayView2, Axis, Zip};
...
#[pymodule]
#[pyo3(name = "great_circle")]
pub mod great_circle {
    use super::{point::SphericalPoint, point::SphericalPoints, *};
